...
{
    /// <summary>
    ///     Abstract monad class that holds a value (in a <see cref="Success{T}" /> or an exception (in a
    ///     <see cref="Failure{T}" />.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Returns whether a <see cref="Try{T}" /> is a <see cref="Success{T}" /> (true) or a <see cref="Failure{T}" />
        ///     (false)
        /// </summary>
        ...
        /// <summary>
        ///     Gets the value of the <see cref="Try{T}" /> if it is a <see cref="Success{T}" />, and throws an exception if it is
        ...
        /// <summary>
        ///     Gets the value of the <see cref="Try{T}" /> if it is a <see cref="Success{T}" />, and the dafult value of T if it
        ///     is a <see cref="Failure{T}" />
        /// </summary>
        ...
        /// <summary>
        ///     Return this <see cref="Try{T}" /> if it is a <see cref="Success{T}" /> or the result of <paramref name="other" />
        ///     if it is a <see cref="Failure{T}" />
        /// </summary>
        /// <param name="other"></param>
        /// <returns></returns>
        ...
        /// <returns>
        ///     A <see cref="Success{T}" /> if the function does not throw an exception, a <see cref="Failure{T}" /> if it
        ///     does, holding the exception
        /// </returns>
        ...
        /// <returns>
        ///     <see cref="Success{T}" /> if invoking function does not throw an exception, a <see cref="Failure{T}" />
        ///     otherwise
        /// </returns>
